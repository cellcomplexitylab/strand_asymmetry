...
a = read.table("learning_curves_24h-PCR_full.txt")
b = read.table("learning_curves_24h-PCR_null.txt")
...
pdf("figures/learning_curves_conflict.pdf", useDingbats=FALSE, height=3, width=5)
par(mar=c(3,3,0.5,1))
plot(1:100, am, lwd=3, type="n", ylim=c(-5.5,-0.5),
