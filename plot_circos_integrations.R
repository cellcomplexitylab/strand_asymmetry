...
AG1 = subset(read.table("mapping/AG1.ins.gz"), V2 != "pT2")
AG2 = subset(read.table("mapping/AG2.ins.gz"), V2 != "pT2")
TG1 = subset(read.table("mapping/TG1.ins.gz"), V2 != "pT2")
TG2 = subset(read.table("mapping/TG2.ins.gz"), V2 != "pT2")
AC1 = subset(read.table("mapping/AC1.ins.gz"), V2 != "pT2")
